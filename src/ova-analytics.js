(function () {
  ...
  /* The remote collector was a Netlify function and no longer exists. All the
     analytics this site actually reads back (window.ovaAnalytics.getStore) is
     kept in localStorage by the callers, so this is a no-op rather than a POST
     that always fails. Restore a real endpoint here to re-enable forwarding. */
