(function remoteCatalogBootstrap() {
  ...
  /* The remote catalog endpoint was a Netlify function; the site is no longer
     hosted there. The static catalog in js/catalog.js is the source of truth,
     and the homepage already falls back to it when hydration yields nothing,
     so return an empty list instead of firing a request that always 404s. */
